...
const Navbar = () => {
  ...
  return(
    <div className="flex justify-between items-center text-black sticky top-0 container mx-auto p-8 border-b-2">
      <div className="block md:hidden mx-4 mt-2 items-center " onClick={handleNav} >
        {!nav ? <AiOutlineClose size={20} /> : <AiOutlineMenu size={20} /> }
      </div>
      
        <h1 className="w-full decoration-4 text-3xl  font-kanit font-bold">sneakers</h1>
        ...
        <ul className="md:hidden pt-24  mt-4 uppercase">
